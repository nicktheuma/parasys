...
export function BoatTemplate({ wm, hm, dm, materialSpec, materialId, materialHydrated }: TemplateProps) {
  return (
...
export function PackagingTemplate({ wm, hm, dm, materialSpec, materialId, materialHydrated }: TemplateProps) {
  return (
...
export function JewelryTemplate({ wm, hm, dm, materialSpec, materialId, materialHydrated }: TemplateProps) {
  return (
